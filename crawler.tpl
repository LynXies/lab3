...
<form action="/crawler" method="GET">
  <input type="text" size="100" maxlength="100" name="first" placeholder="First page">
  <input type="text" size="100" maxlength="100" name="last" placeholder="Last page">
  <input type="submit" class='button' name="parse" value="PARSE">
</form>
</body>
</html>